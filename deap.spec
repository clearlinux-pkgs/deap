...
Version  : 1.4.1
Release  : 49
URL      : https://github.com/DEAP/deap/archive/1.4.1/deap-1.4.1.tar.gz
Source0  : https://github.com/DEAP/deap/archive/1.4.1/deap-1.4.1.tar.gz
...
%prep
%setup -q -n deap-1.4.1
cd %{_builddir}/deap-1.4.1
pushd ..
cp -a deap-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730087498
